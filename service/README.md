...
Entry is nearly free: a **free 60-second scan** (`tools/scan.php` (in this folder)) the prospect runs on their own machine. Its output is the sales conversation.
...
- `tools/scan.php` (in this folder) — the free scan; also the first step of every audit.
